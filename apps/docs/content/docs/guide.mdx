...
This command will ask you to select the hooks you want to import from the list of available hooks through the [API](/docs/api#limitations). You can select multiple hooks by pressing the `space` key.
